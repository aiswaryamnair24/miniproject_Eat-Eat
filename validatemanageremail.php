...
if(isset($_POST['btn']))
{
  ...
  if($tokenfrom==$cnt)
  {
    ...
    $sql = "INSERT INTO `tbl_agency` ( `mname`, `mplace`,`memail`,
    `mpassword`,`value`,`date`) VALUES ('$username','$place','$useremail',
    '$password','0',current_timestamp())";
...
<div class="signup-form">
    <form action="validatemanageremail.php" method="post"  name="rentform" >
