...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $p = "SELECT * FROM tbl_login WHERE username='$mname'";
   $p2 = mysqli_query($conn, $p);
   $p3=mysqli_num_rows($p2);
   $token=rand(100, 550000);
       $s = "SELECT * FROM tbl_agency WHERE memail='$memail'";
       $res = mysqli_query($conn, $s);
       $nu=mysqli_num_rows($res);
       $s2 = "SELECT * FROM tbl_registration WHERE useremail='$memail'";
       $res2 = mysqli_query($conn, $s2);
       $nu2=mysqli_num_rows($res2);
       if($nu==0 && $nu2==0)
       {
       
            if($p3==0) {
        
              $_SESSION['uname']= $mname;
              $_SESSION['place']= $mplace;
           
              $_SESSION['useremail']= $memail;
              $_SESSION['password']= $password;
              $tokdel = "DELETE from temp";
              $ptl = mysqli_query($conn, $tokdel);
              $po = "INSERT INTO `temp`(`email`, `token`) VALUES ('$memail','$token')";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item"><a href="index.html" class="nav-link">Home</a></li>
					<li class="nav-item"><a href="userreg.php" class="nav-link">User Register</a></li>
...
<script>
                  ...
                  if(place.length<3||place.length>10){
                    document.getElementById('placer').innerHTML="Between 4 to 20 characters";
                  ...
                  if (val.match(/^[A-Za-z0-9 ]*$/)) 
                  {
                    ...
                    document.getElementById('msg1').innerHTML="Only alphabets and numbers are allowed";
                          document.getElementById('name').value = val;
                          document.getElementById('name').style.color = "red";
...
function Validatepassword()
                ...
                function Confirmpass()
                  ...
                  function Val()
                  {
                    if(Validate()===false || Validateplace()===false || ValidateEmail()===false || Validatepassword()===false || Confirmpass()===false)
                    {
                      return false;
                    }
                  }
...
<?php     
   ...
   ?>           
    <form action="managerreg.php" method="post"  name="rentform" onsubmit="return Val()">
        <h2>Manager</h2>
        ...
        <div class="form-group">
            <input type="text"  style="border:1px solid blue" class="form-control" name="mname" id="name" placeholder="Name" onblur="return Validate()" required="required">
            <span id="msg1" style="color:red"></span> 
        </div> 
        <div class="form-group">
            <input type="email"  style="border:1px solid blue" class="form-control" name="memail" id="email" placeholder="email" onblur="return ValidateEmail()" required="required">
            <span id="emailer" style="color:red"></span> 
        </div> 
        <div class="form-group">
            <input type="text"  style="border:1px solid blue" class="form-control" name="mplace" id="place" placeholder="place" onchange="return Validateplace()"  required>
            <span id="placer" style="color:red"></span> 
        </div>  
        <div class="form-group">
